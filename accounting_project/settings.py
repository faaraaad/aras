"""
Django settings for accounting_project.
"""
import os
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-test-key-for-aras2-accounting-system')
...
# Detect WhiteNoise availability
try:
    import whitenoise
    HAS_WHITENOISE = True
except ImportError:
...
# Static files and WhiteNoise storage configuration
STORAGES = {
    "default": {
...
# Celery Configuration (Optional / Scalability setup)
